...
import 'package:codekaze_free_ui_kit/module/clean_ecommerce_ui_kit/ce_login/controller/ce_login_controller.dart';

import 'package:get/get.dart';

class CeLoginView extends StatelessWidget {
  final controller = Get.put(CeLoginController());

  @override
  Widget build(BuildContext context) {
    controller.view = this;

    return GetBuilder<CeLoginController>(
      builder: (_) {
        return Scaffold(
          body: SafeArea(
            child: Container(
